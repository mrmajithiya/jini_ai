    ...
    return (
        <main className="bg-gray-100">
            <div className={`min-h-screen flex ${theme === 'light' ? 'bg-gray-50' : 'bg-gray-900'}`}>
                ...
                <button
                    onClick={toggleTheme}
                    className={`fixed top-4 right-4 p-3 rounded-full ${theme === 'light' ? 'bg-white text-gray-800 shadow-lg' : 'bg-gray-800 text-white'} hover:opacity-80 transition-opacity z-10`}
                    ...
                    <div className="max-w-md w-full space-y-8">
                        <div>
                            <div className="flex justify-center">
                                <div className={`w-16 h-16 rounded-full ${theme === 'light' ? 'bg-blue-500' : 'bg-blue-600'} flex items-center justify-center`}>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`mt-1 appearance-none relative block w-full px-3 py-3 border ${theme === 'light' ? 'border-gray-300 bg-white text-gray-900' : 'border-gray-600 bg-gray-700 text-white'} placeholder-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent`}
                                        placeholder="Enter your email"
                                    />
                                </div>
                                <div>
                                    <label htmlFor="password" className={`block text-sm font-medium ${theme === 'light' ? 'text-gray-700' : 'text-gray-300'}`}>
                                        Password
                                    </label>
                                    <input
                                        id="password"
                            ...
                            <div className="text-center">
                                ...
                                <div className=" mt-2 mb-5 flex justify-center items-center gap-4">
                                    ...
                                    onClick={loginWithGithub}>
                                        <FaGithub size={24} className={`text-black ${theme === 'light'? 'text-black': 'text-white'} `}/>
                                    </button>
